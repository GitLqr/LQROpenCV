...
//void getFaceSection(Mat &image, long &thiz, vector<cv::Rect> &faceSection) {
//    cv::Mat imageGray;
//    cvtColor(image, imageGray, COLOR_BGR2GRAY);
//    ((DetectorAgregator *) thiz)->tracker->process(imageGray);
//    ((DetectorAgregator *) thiz)->tracker->getObjects(faceSection);
...
//            makePtr<CascadeClassifier>(cascadePath));
//    cv::Ptr<CascadeDetectorAdapter> trackingDetector = makePtr<CascadeDetectorAdapter>(
//            makePtr<CascadeClassifier>(cascadePath));
//    jlong result = (jlong)new DetectorAgregator(mainDetector, trackingDetector);
//    if (faceSize > 0)
//    {
